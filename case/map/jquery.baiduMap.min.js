    ...
    t.prototype = {
        ...
        renderMarker: function() {
            ...
            function(n, o) {
                ...
                l && t.renderLabel(o),
                n === a.index && t.openInfoWindow(o.id),
                c.addEventListener("click",
                function() {
                    t.openInfoWindow(o.id),
        ...
        openInfoWindow: function(t) {
            ...
            s && (c = '<div class="' + o.titleClass + '">' + i.title + '<img class="open-panorama-btn" src="panorama.png" style="margin-left:12px;cursor:pointer;vertical-align:sub;" title="查看全景" /></div>');
